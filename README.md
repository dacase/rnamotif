...
1.  Edit the "config.h" file in this directory to suit your local 
...
2. Now "make" will make the executables, leaving them in the src
...
3. Set and export the environment variable EFNDATA to point to the efndata
